...
from utils import Flux,set_ddim_timesteps,set_flow_timesteps,save_difference_image,get_custom_timesteps
import os
...
for prompt in prompt_list:
    ...
    output_dir = "outputs/Flux/start_from_image_custom_timesteps_inferences_15"
