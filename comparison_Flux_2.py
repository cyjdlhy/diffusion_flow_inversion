...
for file in file_list:
    ...
    output_dir = f"outputs/Flux/start_from_sd3_image_custom_lin_inferences_{num_inference_steps}_cfg_{guidance_scale}_res_{height}_{width}"
